...
__DEFAULT_SERVER__ = u'http://localhost:8084/AlgoLink/'
...
def test(server=__DEFAULT_SERVER__):
    ...
    __BUILDER_TYPE__ = u'com.artistech.algolink.core.DataBuilderConfig'
    __TEST_TYPE__ = u'com.artistech.algolink.orgs.scenario1.Scenario1Config'

    #a = AlgoLink(u'http://192.168.1.12:8080/')
    a = AlgoLink(server)
    ...
    org_cfg = a.get_config_schema(__TEST_TYPE__)
    ...
    org_list = [{__TEST_TYPE__: org_cfg}, {__BUILDER_TYPE__: db_cfg}]

    # print u'Org Config: ' + __TEST_TYPE__
    # print org_cfg
    # print u'DataBuilder Config: ' + __BUILDER_TYPE__
    # print db_cfg
